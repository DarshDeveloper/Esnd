        ...
        <table class="table table-bordered">
            ...
            @foreach($masnods as $masnods)
                <tr>
                    ...
                    <td><img src="//esndco.com/public/attachments/{!! $masnods->social_id_front_photo !!}" style="width:100px;height:100px"> </td>
                    <td><img src="//esndco.com/public/attachments/{!! $masnods->social_id_back_photo !!}" style="width:100px;height:100px"></td>
