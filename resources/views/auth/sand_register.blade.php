                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <h3 class="text-left">Sand Register</h3>
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9"> 
                                            <input type="email" class="form-control for{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" placeholder="ُEmail" id="email" value="{{ old('email') }}">
                                            @if ($errors->has('email'))
                                                <span class="text-danger" role="alert">
